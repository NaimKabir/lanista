...
class Arena(object):
    ...
    def stop_condition(self, state):
        """
        Some state should be a termination state of the game, as specified by this method.
        """

        self._stop_condition(state)
    ...
    def _stop_condition(self, state): raise NotImplementedError
    def _register(self, agent): raise NotImplementedError
    def _receive(self, action): raise NotImplementedError
...
class Agent(object):
    ...
    def _receive(self, state, reward): raise NotImplementedError
    def _learn(self, reward): raise NotImplementedError
...
class Game(object):
    ...
    def __init__(self, arena, agent_array):
        self.arena = arena
    ...
    def run(self, episodes = 1):
        ...
        while episode < episodes:
            ...
            if self.arena.stop_condition(self.arena.state):
                self.arena.reset()
                episode += 1
